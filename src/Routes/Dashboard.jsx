                  ...
                  <div className='contside2'>
                      <div className='contside22'>
                        ...
                        <div className='smallbox'>
                            ...
                            <div className='smallcard'>
                              ...
                              <path d="M20.6176 7.57528C20.6176 10.1021 18.8795 12.1506 16.7353 12.1506C14.5911 12.1506 12.8529 10.1021 12.8529 7.57528C12.8529 5.04842 14.5911 3 16.7353 3C18.8795 3 20.6176 5.04842 20.6176 7.57528Z" fill="#464F60"/>
                              <path d="M24.5 19.0135C24.5 21.793 20.5471 20.8436 16.7353 20.8436C12.9234 20.8436 8.97058 21.793 8.97058 19.0135C8.97058 16.2339 12.9234 13.9807 16.7353 13.9807C20.5471 13.9807 24.5 16.2339 24.5 19.0135Z" fill="#464F60"/>
                              <path d="M14.8293 6.83783C14.8293 9.78583 12.8383 12.1757 10.3823 12.1757C7.92623 12.1757 5.93522 9.78583 5.93522 6.83783C5.93522 3.88983 7.92623 1.5 10.3823 1.5C12.8383 1.5 14.8293 3.88983 14.8293 6.83783Z" fill="#464F60"/>
                              <path d="M19.2764 20.1824C19.2764 23.4252 14.7486 22.3175 10.3823 22.3175C6.01598 22.3175 1.48816 23.4252 1.48816 20.1824C1.48816 16.9396 6.01598 14.3108 10.3823 14.3108C14.7486 14.3108 19.2764 16.9396 19.2764 20.1824Z" fill="#464F60"/>
                              <path d="M14.8293 6.83783C14.8293 9.78583 12.8383 12.1757 10.3823 12.1757C7.92623 12.1757 5.93522 9.78583 5.93522 6.83783C5.93522 3.88983 7.92623 1.5 10.3823 1.5C12.8383 1.5 14.8293 3.88983 14.8293 6.83783Z" stroke="white" stroke-width="0.588235"/>
                              <path d="M19.2764 20.1824C19.2764 23.4252 14.7486 22.3175 10.3823 22.3175C6.01598 22.3175 1.48816 23.4252 1.48816 20.1824C1.48816 16.9396 6.01598 14.3108 10.3823 14.3108C14.7486 14.3108 19.2764 16.9396 19.2764 20.1824Z" stroke="white" stroke-width="0.588235"/>
                              </svg>
                      ...
                      <div className='box2'>
                        <div className='boxcont'>
                          <svg width="58" height="38" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect x="5" y="5" width="48" height="48" rx="24" fill="#31B550"/>
                          <path d="M42 25.0039V23.8438C42 22.5148 40.8248 21.4375 39.375 21.4375H20.625C19.1753 21.4375 18 22.5148 18 23.8438V25.0039C18 25.1225 18.105 25.2188 18.2344 25.2188H41.7656C41.895 25.2188 42 25.1225 42 25.0039Z" fill="white"/>
                          <path d="M18 26.8086V34.1562C18 35.4852 19.1753 36.5625 20.625 36.5625H39.375C40.8248 36.5625 42 35.4852 42 34.1562V26.8086C42 26.69 41.895 26.5938 41.7656 26.5938H18.2344C18.105 26.5938 18 26.69 18 26.8086ZM24 32.4375C24 32.8172 23.6642 33.125 23.25 33.125H22.5C22.0858 33.125 21.75 32.8172 21.75 32.4375V31.75C21.75 31.3703 22.0858 31.0625 22.5 31.0625H23.25C23.6642 31.0625 24 31.3703 24 31.75V32.4375Z" fill="white"/>
                          <rect x="5" y="5" width="48" height="48" rx="24" stroke="#31B550" stroke-opacity="0.1" stroke-width="9"/>
                          </svg>
                          <p>deposited</p>
                        </div>
                        <h2>18</h2>
                      ...
                      <div className='box2'>
                        ...
                        <svg width="58" height="38" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M33.3412 24.3378C33.3412 27.2858 31.3502 29.6757 28.8941 29.6757C26.4381 29.6757 24.4471 27.2858 24.4471 24.3378C24.4471 21.3898 26.4381 19 28.8941 19C31.3502 19 33.3412 21.3898 33.3412 24.3378Z" fill="white"/>
                          <path d="M37.7882 37.6824C37.7882 40.9252 33.2604 39.8175 28.8941 39.8175C24.5278 39.8175 20 40.9252 20 37.6824C20 34.4396 24.5278 31.8108 28.8941 31.8108C33.2604 31.8108 37.7882 34.4396 37.7882 37.6824Z" fill="white"/>
                          <rect x="5" y="5" width="48" height="48" rx="24" stroke="#4945C4" stroke-opacity="0.1" stroke-width="9"/>
                          </svg>
